...
public class BinaryTreeNode<E> {
    ...
    public boolean equals(Object o) {
        ...
        BinaryTreeNode item = (BinaryTreeNode) o;
        return (left == null?item.left==null:left.equals(item.left))
                &&(parent==null?item.parent==null:parent.equals(item.parent))
                &&(right==null?item.right==null:right.equals(item.right));
    }
